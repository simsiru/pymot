...
def draw_bbox_tracking(coords: tuple, height: int, frame: np.ndarray, tracking_id: int,
class_name: str='', rand_colors: bool=True, rec_bool: bool=False,
colors: tuple=((0,255,0),(0,0,255)), info_text: str='', unknown_obj_info: str='UNKNOWN') -> None:
