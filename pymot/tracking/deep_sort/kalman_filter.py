...
class KalmanFilter(object):
    ...
    location (x, y, a, h) is taken as direct observation of the
    state space (linear observation model).
    """
    ...
    def initiate(self, measurement):
        ...
        (ndarray, ndarray)
            ...
            (8x8 dimensional) of the new track. Unobserved velocities are
    ...
    def update(self, mean, covariance, measurement):
        ...
        measurement : ndarray
            ...
            is the center position, a the aspect ratio, and h the
    ...
    def gating_distance(
        ...
        """Compute gating distance between state distribution and
        measurements. A suitable distance threshold can be obtained
        from `chi2inv95`. If `only_position` is False, the chi-square
